...
#### 4.7.5 知乎用户图谱 · 多数据源交叉网络分析（v3 深度扩展）

> **完整报告见**：[`zhihu-user-graph.md`](./zhihu-user-graph.md)（v3 深度扩展版，32.4 KB）
>
> **2026-06-21 抓取** · 登录账号 SimmerChan · 涉及 **545 位用户**
...
| **v3** | **12** | **545** | **120+** | **3+** | **6+** (新增田渊栋/俞扬/张俊林/王喆) |

**v3 新增 6 个数据源**（从"我的关注" 3 跳扩展）：

| # | 数据源 | 抓取 | 数量 |
|---|--------|------|------|
| 7 | **程引 (Shopee 推荐) 关注** | `/api/v4/members/cheng-yin-36/followees` | 60 |
| 8 | **0xC001 关注** | `/api/v4/members/mlpod/followees` | 27 |
| 9 | **傅聪_Cong 关注** | `/api/v4/members/FU-CONG-BEN/followees` | 48 |
| 10 | **Tim 在路上关注** | `/api/v4/members/lao-zhang-cao-mei-yuan/followees` | 60 |
| 11 | **DataMan (抖音 feed) 关注** | `/api/v4/members/tao-xue-wen-54-98/followees` | 60 |
| 12 | **萧瑟 (王哲) 关注** | `/api/v4/members/tttwwy/followees` | 60 |

**v3 选 6 个高可信用户的象限覆盖**：
- ① **Shopee 推荐**（程引 - 上交）② **阿里大模型**（0xC001）③ **学术**（傅聪_Cong - 浙大博士）
- ④ **一线+公众号**（Tim 在路上 - 北邮）⑤ **字节抖音**（DataMan）⑥ **广告/推荐**（萧瑟 - 优秀回答者）

**v3 新发现 · 跨 3 源超级节点**：

| 姓名 | people ID | 身份 | 出现源 |
|------|----------|------|--------|
| **九老师** | nphard-79 | TikTok / 推荐算法工程师 | SimmerChan / GuoXun 关注 / GuoXun 关注者 |
| **李博杰** | li-bo-jie | **中科大+MSRA 联培计算机博士 / AI 创业者** | 傅聪 / 0xC001 / Tim |

**v3 跨 2 源关键 11 人**（网络图谱的"节点"）：

| 姓名 | people ID | 业务价值 | 出现源 |
|------|----------|---------|--------|
| **王喆** | wang-zhe-58 | 清华 / 广告推荐 ED | Tim + Q1 |
| **苏剑林** | su-jian-lin-22 | 数学/数据挖掘 | 0xC001 + Tim |
| **萧瑟 (王哲)** | tttwwy | 广告/推荐/炼丹实验室 | 0xC001 + 傅聪 |
| **Taki** | wu-tai-qiang | THU 本硕 / HKU 博 | 0xC001 + 萧瑟 |
| **ybq** | ybq-29-32 | NLP / 中科院硕士 | 0xC001 + 萧瑟 |
| **林深见志** | justopit | ai 用我 | 程引 + 萧瑟 |
| **被推荐的人生回路** | jolan-17 | ai | 程引 + 萧瑟 |
| **周国睿** | zhou-guo-rui-25 | 欢迎自荐 | 程引 + DataMan + 萧瑟 |
| **知乎科技** | zhi-ke-ji-13 | 官方账号 | 0xC001 + 傅聪 |

**v3 新增顶级大 V**：

| 类别 | 用户 | 身份 |
|------|------|------|
| **学术顶流** | **田渊栋** (tian-yuan-dong) | **Recursive.com 联创 / 前 MetaAI 总监** |
| **学术顶流** | **俞扬** (eyounx) | **南京大学人工智能学院教授** |
| **学术顶流** | **张俊林** (zhang-jun-lin-76) | **中科院软件所博士** / 优秀回答者 |
| **学术 PhD** | **Milo** (mailuo) | 爱丁堡大学助理教授 / 机器学习系统 |
| **学术 PhD** | **SIY.Z** (siyz) | UCB CS PhD |
| **学术 PhD** | **sonta** (buhezuobugaoxing) | **PhD @ MIT CSAIL** |
| **学术 PhD** | **尤洋** (berkeley-you-yang) | 中国农大→**清华→伯克利→新国立** |
| **学术 PhD** | **Triborg** (yongle-li-86) | **上海大学"量子科技"教授** / 优秀回答者 |
| **学术 PhD** | **寒月灼华** (han-yue-zhuo-hua) | **PHD@CMU / SJTU ACM** |
| **业务顶流** | **水哥** (shui-ge-99) | **《现代推荐算法》作者** / 清华硕 |
| **业务顶流** | **曾天真** (ceng-tian-zhen-12) | **阿里巴巴-内容AI算法带队中** |
| **业务顶流** | **沪漂城哥** (cheng-nan-jiu-shi-73-3) | **微软算法专家，专注大模型、智能体、搜广推** |
| **业务顶流** | **godweiyang** | 公众号《算法码上来》/ **字节跳动员工** |
| **业务顶流** | **BR 的纸飞机** (zhong-xian-sheng-4-44) | 公众号 / **字节 + 阿里员工** |
| **业务顶流** | **杜佳慧** (du-jia-hui-52) | **字跳网络员工**（字节）|
| **业务顶流** | **陀飞轮** (chen-jia-yu-65-36) | **小红书 hi lab 多模基座** / 复旦硕士 |
| **业务顶流** | **Sia 王月饼** (ge-zi-1-12-9) | **腾讯科技员工** |
| **业务顶流** | **课代表立正** (sun-yu-zheng) | 腾讯游戏 / Facebook 资深数据科学家 |
| **业务顶流** | **mannaandpoem** (liang-xin-bing-13) | **OpenManus 作者 / MetaGPT 核心贡献者** |
| **业务顶流** | **Mingfei** (ma-ming-fei-72) | **PyTorch CPU Perf Maintainer** |

**v3 厂商覆盖完整度**（11 家）：

| 厂商 | 覆盖 | 代表 |
|------|------|------|
| 字节跳动 | ✓✓ | BR/王喆/杜佳慧/godweiyang/DataMan (feed) |
| 阿里巴巴 | ✓✓ | 浅梦/0xC001/曾天真/高晨/小柚/硅基趣玩喵 |
| 腾讯 | ✓ | 课代表立正 (游戏) / Sia 王月饼 |
| 微软 | ✓ | 沪漂城哥 / 王晋东 (前 MSRA) |
| 谷歌 | ✓ | 李 rumor (开发者专家) |
| 亚马逊 | ✓ | 李沐 (首席科学家) |
...
| 小红书 | ✓ | 陀飞轮 (hi lab) |
| 字节/抖音 | ✓✓ | DataMan / BR / 杜佳慧 |
| 百度 | ✓ | GuoXun |
| Shopee | ✓ | 程引 |

**v3 关键洞察**：

1. **3 源超级节点 = 推荐算法 + 学术 + 创业的三重交叉**：九老师 (TikTok 推荐) + 李博杰 (MSRA 博士 + AI 创业) + 0xC001 (阿里大模型)
2. **6 源用户跨域广** — 比如 苏剑林 出现在 0xC001 + Tim 在路上关注列表中
3. **v3 比 v2 增加了 4 跳**（不止 1 跳）：从 SimmerChan 关注 → 6 个高可信作者 → 6 个作者的 315 个关注
4. **方法学升级**：从"互关对"升级到"象限覆盖的二次网络" — 选 6 个用户时分象限（Shopee/阿里/学术/字节/广告/一线公众号）

**v3 推荐 SimmerChan 加关注 Top 20**（更新自 v2 的 Top 15）：

1-3. 浅梦 / 王喆 / 九老师 ✓ 已有
4-6. GuoXun / 0xC001 / 傅聪_Cong
7. **李博杰** (3 源覆盖 / 中科大+MSRA 博士 / AI 创业) ⭐
8. **萧瑟 (王哲)** (广告/推荐/炼丹实验室)
9. **DataMan** (抖音 feed)
10. **林建入** (公众号《林建入和他的怪朋友们》/ 优秀回答者)
11. **俞扬** (南大人工智能学院教授)
12. **田渊栋** (前 MetaAI 总监)
13. **张俊林** (中科院软件所博士)
14. **水哥** (《现代推荐算法》作者)
