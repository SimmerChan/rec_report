...
#### 4.7.5 知乎用户图谱 · SimmerChan 关注网络 + 完整 Profile 报告

> **完整报告见**：[`zhihu-user-graph.md`](./zhihu-user-graph.md)（独立 markdown，378 行 / 18.4 KB）
>
> **2026-06-21 抓取** · 登录账号 SimmerChan · 涉及 28 位用户（文档作者 10 + 我关注 19 - 1 交集）
...
|------|------|
| 总用户数 | **28** |
| AI/推荐/MLSys 强相关 | 15（54%）|
| 我关注 ∩ 文档作者 | **1**（浅梦）|
| ⭐⭐⭐⭐⭐ 高可信 | 4（浅梦 / GuoXun / 0xC001 / 傅聪_Cong）|
| 建议加关注的优质作者 | **9**（均未在 SimmerChan 关注列表）|

**SimmerChan 关注网络中的 8 位 AI/推荐强相关用户**（已关注）：

| 用户 | 身份 | 关注 | 推荐理由 |
|------|------|------|---------|
| 浅梦 (shenweichen) | 阿里·推荐算法 / 浙大 CS 硕 | 14,973 | ⭐⭐⭐⭐⭐ + 互关 |
| 王喆 (wang-zhe-58) | 清华 / 广告推荐 Engineering Director | — | 知乎推荐系统顶流 |
| 九老师 (nphard-79) | 新加坡 / 推荐算法工程师 | — | 学术 + 工业结合 |
| 金雪锋 (jin-xue-feng) | 北邮 / Agent Infra | — | 前沿方向 |
| yahah (yahah-97) | 国科大 / GPGPU | — | 公众号《GPGPU 架构分析》|
| 杨军 (yang-jun-14) | 日本 / MLSys | — | 大规模机器学习系统 |
| 有了琦琦的棍子 (ban-zhuan-yuan-shi-chao-ji-gun) | 北京 / HPC+MLsys | — | 系统方向 |
| xiao_bai (xiao-bai-54-68-75) | AI 评论员 | — | 行业观察 |

**建议加关注的 9 位优质作者**（文档作者 ∩ 文档已收录 ∩ SimmerChan 未关注）：

1. **GuoXun (guo-xun-16)** ⭐⭐⭐⭐⭐ — 10,841 关注 / 全栈解读（最优先）
2. **0xC001 (mlpod)** ⭐⭐⭐⭐⭐ — 4,026 关注 / 阿里大模型认证
3. **傅聪_Cong (FU-CONG-BEN)** ⭐⭐⭐⭐⭐ — 13,343 关注 / OnePiece 发明者
4. **州懂 (14jzzhan)** ⭐⭐⭐⭐ — 3,666 关注 / 大厂算法
5. **疯刀 (xi-bei-di-qu-wei-yi-de-wang-ji)** ⭐⭐⭐⭐ — 905 / 推荐算法
6. **mqfcu7 (lu-shuai-4-46)** ⭐⭐⭐⭐ — 190 / 顶会跟踪
7. **Keep Learning (keep-learning-78-60)** ⭐⭐⭐ — 1,356 / 字节架构
8. **几野 (zhou-yong-chao-71)** ⭐⭐⭐ — 259 / 字节 OneTrans
9. **血稳 (xiao-wen-pku)** ⭐⭐ — 77 / 多厂解读

**关键洞察**：

1. **浅梦是唯一"互关"** — SimmerChan 关注浅梦，浅梦的文章 SimmerChan 也赞过（2026-06-17 赞过）
2. **42% 关注度集中在 AI/推荐** — 19 个关注里 8 个是 AI/推荐，6 个是生活/娱乐/政治
3. **9 位高可信作者我没关注** — 但写出了本文档 80% 的高质量引用
4. **IP 分布以北京/广东/海外（新加坡/日本）为主** — 符合 AI/推荐行业地理分布
