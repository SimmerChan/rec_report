...
- **2024年**：各厂商密集跟进，快手OneRec、字节HLLM、美团MTGR、腾讯OnePiece相继发布
...
腾讯/Shopee的OnePiece论文（arXiv:2509.18091）很有特色，用的是LLM式上下文工程注入推荐，Block-wise隐式推理。2026年的方向明显转向广告：GPR（端到端生成广告）、OneRanker（generation与ranking架构级协同）。
