...
| VLM (Late Materialization) | [2604.24806](https://arxiv.org/abs/2604.24806) | - | 2026 |
...
| SUAN | [未公开/内部](https://arxiv.org/search/?query=SUAN+recommendation) | 美团 | 2025 |
| HoMer | [未公开/内部](https://arxiv.org/search/?query=HoMer+recommendation) | 美团 | 2025 |

**说明**：
- OneTrans 已录用为 **WWW 2026** 论文
- GR/HSTU 发表为 **ICML 2024** 论文
- SUAN、HoMer 暂未在 arXiv 或公开渠道找到，疑为美团内部工作
- 其余均为 arXiv 预印本
